...
class TestFormat {
    ...
    @Test
    void testFormatZero() {
        val mesg = Nope.fault(PmCustMsg.of("T001", "Messagge zero")).failure().message();
    ...
    void testFormatArgTwo() {
        val mesg = Nope.fault(PmCustMsg.of("T002", "Messagges: {}, {}"), "Hola", "Mundo").failure().message();
        log.info("Message: {}", mesg);
        Assertions.assertEquals("Messagges: Hola, Mundo", mesg);
    }
    @Test
    void testFormatEscape() {
        val mesg = Nope.fault(PmCustMsg.of("T002", "Messagge hot \\{}{}"), '*').failure().message();
        log.info("Message: {}", mesg);
    ...
    void testFormatMissingArgs() {
        val mesg = Nope.fault(PmCustMsg.of("T002", "Messagges: {}, {}"), 1).failure().message();
        log.info("Message: {}", mesg);
        Assertions.assertEquals("Messagges: 1, {}", mesg);
    }
    @Test
    void testFormatArgsOberflow() {
        val mesg = Nope.fault(PmCustMsg.of("T002", "Messagges: {}"), 1, 2).failure().message();
        log.info("Message: {}", mesg);
        Assertions.assertEquals("Messagges: 1", mesg);
    }
    @Test
    void testFormatOject() {
        val mesg = Nope.fault(PmCustMsg.of("T002", "Messagge obj->{}"), BigInteger.ZERO).failure().message();
        log.info("Message: {}", mesg);
        Assertions.assertEquals("Messagge obj->0", mesg);
    }
    @Test
    void testFormatBoolean() {
        val mesg = Nope.fault(PmCustMsg.of("T002", "Messagge bool->{}"), true).failure().message();
        log.info("Message: {}", mesg);
        Assertions.assertEquals("Messagge bool->true", mesg);
    }
    @Test
    void testFormatByte() {
        val mesg = Nope.fault(PmCustMsg.of("T002", "Messagge byte->{}"), (byte) 0xff).failure().message();
        log.info("Message: {}", mesg);
        Assertions.assertEquals("Messagge byte->-1", mesg);
    }
    @Test
    void testFormatChar() {
        val mesg = Nope.fault(PmCustMsg.of("T002", "Messagge char->{}"), (char) 65).failure().message();
        log.info("Message: {}", mesg);
        Assertions.assertEquals("Messagge char->A", mesg);
    }
    @Test
    void testFormatShort() {
        val mesg = Nope.fault(PmCustMsg.of("T002", "Messagge short->{}"), (short) 0xffff).failure().message();
        log.info("Message: {}", mesg);
        Assertions.assertEquals("Messagge short->-1", mesg);
    }
    @Test
    void testFormatInt() {
        val mesg = Nope.fault(PmCustMsg.of("T002", "Messagge int->{}"), 0xffffffff).failure().message();
        log.info("Message: {}", mesg);
        Assertions.assertEquals("Messagge int->-1", mesg);
    }
    @Test
    void testFormatLong() {
        val mesg = Nope.fault(PmCustMsg.of("T002", "Messagge long->{}"), 0xffffffffffffffffL).failure().message();
        log.info("Message: {}", mesg);
        Assertions.assertEquals("Messagge long->-1", mesg);
    }
    @Test
    void testFormatFloat() {
        val mesg = Nope.fault(PmCustMsg.of("T002", "Messagge float->{}"), 3.14F).failure().message();
        log.info("Message: {}", mesg);
        Assertions.assertEquals("Messagge float->3.14", mesg);
    }
    @Test
    void testFormatDouble() {
        val mesg = Nope.fault(PmCustMsg.of("T002", "Messagge dble->{}"), 3.14159265897932384626433832).failure().message();
        log.info("Message: {}", mesg);
    ...
    void testFormatOjectArray() {
        ...
        val mesg = Nope.fault(PmCustMsg.of("T002", "Messagge obj->{}"), arg).failure().message();
        log.info("Message: {}", mesg);
    ...
    void testFormatBooleanArray() {
        ...
        val mesg = Nope.fault(PmCustMsg.of("T002", "Messagge bool->{}"), arg).failure().message();
        log.info("Message: {}", mesg);
    ...
    void testFormatByteArray() {
        ...
        val mesg = Nope.fault(PmCustMsg.of("T002", "Messagge byte->{}"), arg).failure().message();
        log.info("Message: {}", mesg);
    ...
    void testFormatCharArray() {
        ...
        val mesg = Nope.fault(PmCustMsg.of("T002", "Messagge char->{}"), arg).failure().message();
        log.info("Message: {}", mesg);
    ...
    void testFormatShortArray() {
        ...
        val mesg = Nope.fault(PmCustMsg.of("T002", "Messagge short->{}"), arg).failure().message();
        log.info("Message: {}", mesg);
    ...
    void testFormatIntArray() {
        ...
        val mesg = Nope.fault(PmCustMsg.of("T002", "Messagge int->{}"), arg).failure().message();
        log.info("Message: {}", mesg);
    ...
    void testFormatLongArray() {
        ...
        val mesg = Nope.fault(PmCustMsg.of("T002", "Messagge long->{}"), arg).failure().message();
        log.info("Message: {}", mesg);
    ...
    void testFormatFloatArray() {
        ...
        val mesg = None.builder().withAlert(PmCustMsg.of("T002", "Messagge float->{}"), arg).build().signals().iterator().next().message();
        log.info("Message: {}", mesg);
    ...
    void testFormatDoubleArray() {
        ...
        val mesg = None.builder().withAlert(PmCustMsg.of("T002", "Messagge dble->{}"), arg).build().signals().iterator().next().message();
        log.info("Message: {}", mesg);
