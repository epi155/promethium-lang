...
public interface SearchResultBuilder<R> {
    ...
    interface Found<S, R> {
         ...
         * @return      instance of partial builder {@link NotFound}
         */
        @NotNull SearchResultBuilder.NotFound<R> onFoundSetError(@NotNull CustMsg ce, Object...argv);
    }
    ...
    interface NotFound<R> {
         ...
         * @return      instance of partial builder {@link SearchResultBuilder}
         */
        @NotNull SearchResultBuilder<R> onNotFoundSetError(@NotNull CustMsg ce, Object... argv);
    }
}
