...
public interface OptoMapElseContext<T, R> {
     ...
     */
    @NotNull OptoMapExitContext<R> maps(@NotNull Function<? super T, ? extends ErrorXorValue<R>> fcn);
     ...
     * @return instance of {@link OptoMapExitContext}
     */
    @NotNull OptoMapExitContext<R> mapsOf(@NotNull Function<? super T, ? extends R> fcn);
